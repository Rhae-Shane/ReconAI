import { getRecords } from "@/lib/close/store";
    ...
    report: {
      ...
      unresolved: detail.exceptions
        ...
        .map((e) => {
          ...
          const actualPaise = e.actualPaise ?? 0;
          const resolved = e.status === "RESOLVED" || e.resolutionStatus === "APPROVED";
          return {
            ...
            status: (resolved ? "RESOLVED" : "NEEDS_REVIEW") as "RESOLVED" | "NEEDS_REVIEW",
          };
        }),
    },
  };
