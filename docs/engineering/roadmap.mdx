---
title: Roadmap
description: Prioritized backlog beyond the hackathon-complete close loop (P0–P3) and explicit non-goals.
---
...
When picking the next slice, prefer anything that **raises measured trust** (isolation, audit, idempotency) before cosmetic dashboard work.
