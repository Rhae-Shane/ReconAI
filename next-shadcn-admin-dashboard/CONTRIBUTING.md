...
If you’d like a more detailed example of this setup, check out the [Next Colocation Template](https://github.com/Rhae-Shane), where the full structure is explained with examples.
...
1. Fork the Repository
   ...
   Click [here](https://github.com/Rhae-Shane) to fork the repository.
...
- Report bugs, suggestions, or issues via [GitHub Issues](https://github.com/Rhae-Shane)
