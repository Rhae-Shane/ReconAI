 ...
 * default entity is returned ({ id:"main", name:"Primary", baseCurrency:"INR" }) so callers always
...
export const DEFAULT_ENTITY: Entity = { id: "main", name: "Primary", baseCurrency: "INR" };
 ...
 * returns the default `{ main / Primary / INR }` entity — no write is performed to seed it.
 */
